...
if(isset($_GET['q'])){
    if($_GET['q']=='1'){
        ...
        if(isset($_POST['sqlFin']) && $_POST['sqlFin'] !=''){
            $fin=$_POST['sqlFin'];//[fecha_ingreso] es cuando ellos dicen que inició, [fecha_inicio] es cuando se metió al sistema
            $sqlFin = "AND fecha_baja>='$fin'";
            array_push($sqlWhere,$sqlFin);
        }
...
<div class="card" id="masterD">
    ...
    <div class="card-body">
        ...
        <form action="backupDashboard.php?q=1" method="POST">
            <div class="row">
                <div class="col-sm-3">
            ...
            <div class="row">
                ...
                <div class="col">
                    ...
                    <input name="sqlFin" type="date" id="inputBaja" class="form-control" placeholder="Ingrese fecha" value="<?php if(isset($fin)) echo($fin);?>">
                </div>
            </div>
            <div class="row">
                <div class="col">
            ...
            <div class="row">
                <div class="col-sm-4">
                    ...
                    <a href="backupDashboard.php" class="btn btn-dark"><i class="fas fa-globe-americas fa-sm"></i> Mostrar todo</a>
                </div>
            </div>
        <form>
    </div>
