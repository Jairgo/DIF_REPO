 ...
 <style>
    ...
    <body id="back">
        <div class="container">
            <?php
                //Navigation -->
                require_once "nav4.php";
                //require_once "buttons.php";
            ?>
            <!--Content-->
            <div class="card" id="masterD">
                <div class="card-header">
                    Búsqueda especializada de nómina de Becarios
                </div>
                <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-2">
                                <label for="inputSueldo">Sueldo
                                    <span id="fas">
                                        <i class="fas fa-info-circle fa-xs" data-toggle="tooltip" data-placement="bottom" title="Ingrese el sueldo actual del becario"></i>
                                    </span>
                                </label>
